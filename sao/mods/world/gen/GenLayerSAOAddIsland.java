...
public class GenLayerSAOAddIsland extends GenLayerSAO
{
    public GenLayerSAOAddIsland(long par1, GenLayerSAO par3GenLayerSAO)
    {
        super(par1);
        this.parent = par3GenLayerSAO;
    }
        ...
        for (int i2 = 0; i2 < par4; ++i2)
        {
            for (int j2 = 0; j2 < par3; ++j2)
            {
                ...
                if (k3 == 0 && (k2 != 0 || l2 != 0 || i3 != 0 || j3 != 0))
                {
                    ...
                    else if (i4 == BiomeGenSAOBase.icePlains.biomeID)
                    {
                        aint1[j2 + i2 * par3] = BiomeGenSAOBase.frozenOcean.biomeID;
                    }
                    else
                    {
                        aint1[j2 + i2 * par3] = 0;
                ...
                else if (k3 > 0 && (k2 == 0 || l2 == 0 || i3 == 0 || j3 == 0))
                {
                    if (this.nextInt(5) == 0)
                    {
                        if (k3 == BiomeGenSAOBase.icePlains.biomeID)
                        {
                            aint1[j2 + i2 * par3] = BiomeGenSAOBase.frozenOcean.biomeID;
                        }
                        else

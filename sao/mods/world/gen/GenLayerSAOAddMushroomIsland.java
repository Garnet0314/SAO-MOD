...
public class GenLayerSAOAddMushroomIsland extends GenLayerSAO
{
    public GenLayerSAOAddMushroomIsland(long par1, GenLayerSAO par3GenLayerSAO)
    {
        super(par1);
    ...
    public int[] getInts(int par1, int par2, int par3, int par4)
    {
        ...
        for (int i2 = 0; i2 < par4; ++i2)
        {
            for (int j2 = 0; j2 < par3; ++j2)
            {
                ...
                {
                    aint1[j2 + i2 * par3] = BiomeGenSAOBase.mushroomIsland.biomeID;
                }
                else
                {
                    aint1[j2 + i2 * par3] = k3;

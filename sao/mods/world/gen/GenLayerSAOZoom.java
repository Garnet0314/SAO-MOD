...
public class GenLayerSAOZoom extends GenLayerSAO
{
    public GenLayerSAOZoom(long par1, GenLayerSAO par3GenLayerSAO)
    {
        super(par1);
    ...
    public static GenLayerSAO magnify(long par0, GenLayerSAO par2GenLayer, int par3)
    {
        Object object = par2GenLayer;

        for (int k = 0; k < par3; ++k)
        {
            object = new GenLayerSAOZoom(par0 + (long)k, (GenLayerSAO)object);
        }

        return (GenLayerSAO)object;
    }
}
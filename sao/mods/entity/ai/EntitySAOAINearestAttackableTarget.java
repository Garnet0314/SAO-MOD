...
public class EntitySAOAINearestAttackableTarget extends EntitySAOAITarget
{
    ...
    public EntitySAOAINearestAttackableTarget(EntityCreature par1EntityCreature, Class par2Class, float par3, float par4, boolean par5)
    {
        this(par1EntityCreature, par2Class, par3, par4, par5, false);
    }

    public EntitySAOAINearestAttackableTarget(EntityCreature par1EntityCreature, Class par2Class, float par3, float par4, boolean par5, boolean par6)
    {
        this(par1EntityCreature, par2Class, par3, par4, par5, par6, (IEntitySelector)null);
    }

    public EntitySAOAINearestAttackableTarget(EntityCreature par1EntityCreature, Class par2Class, float par3, float par4, boolean par5, boolean par6, IEntitySelector par7IEntitySelector)
    {
        super(par1EntityCreature, par3, par5, par6);
        this.targetClass = par2Class;
        this.targetHeight = par4;
        this.theNearestAttackableTargetSorter = new EntitySAOAINearestAttackableTargetSorter(this, par1EntityCreature);

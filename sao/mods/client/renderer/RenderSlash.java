...
public class RenderSlash extends Render
{
    ...
    public void doRenderSlash(EntitySwordSkill par1EntitySwordSkill, double par2, double par3, double par4, float par5, float par6)
    {
        ...
        if(par1EntitySwordSkill.getCount() <= 0)
        {
        	...
        	this.renderLightEffect(tessellator, color % 7, size2, par1EntitySwordSkill);
        }
        //斬撃の描画
        else if (color == 0)
        {
        	...
        	float pitch = par1EntitySwordSkill.rotationPitch;
        	if(pitch > 90.0F)
        	{
        	...
        	GL11.glRotatef(par1EntitySwordSkill.getAngleZ(), 0.0F, 0.0F, 1.0F);

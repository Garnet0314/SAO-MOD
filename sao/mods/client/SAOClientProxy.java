...
import sao.mods.client.renderer.RenderSAOBipedAmbidexter;
...
public class SAOClientProxy implements SAOCommonProxy
{
    ...
    public void registerRenderers()
    {
        ...
        RenderingRegistry.registerEntityRenderingHandler(EntityKirito.class, new RenderSAOBipedAmbidexter(new ModelBiped(0.0F, 0.0F, 64, 64), 0.6F));

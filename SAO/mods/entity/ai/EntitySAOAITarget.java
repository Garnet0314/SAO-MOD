...
public abstract class EntitySAOAITarget extends EntityAIBase
{
    ...
    public EntitySAOAITarget(EntityLiving par1EntityLiving, float par2, boolean par3)
    {
        this(par1EntityLiving, par2, par3, false);
    }

    public EntitySAOAITarget(EntityLiving par1EntityLiving, float par2, boolean par3, boolean par4)
    {
    ...
    protected boolean isSAOSuitableTarget(EntityLiving par1EntityLiving, boolean par2)
    {
        ...
        {
        	if (par1EntityLiving.getClass() == EntityCreeper.class)
        	{
        		return false;
        	}
        	else if (par1EntityLiving.getClass() == EntityGhast.class)
        	{
        		return false;
        	}
